...
namespace MarkupTests
{
    class Test
    {
        private static readonly Dictionary<string, string> _testData = new Dictionary<string, string>
        {
            ...
            { ">qweqwe", "<article><span style=\"color: #789922;\">&gt;qweqwe</span></article>" },
            ...
            { ">test\n>test", "<article><span style=\"color: #789922;\">&gt;test</span><br><span style=\"color: #789922;\">&gt;test</span></article>" },
            { ">>123\n>qq", "<article><a href=\"/Home/DisplayTread/6/#123\">&gt;&gt;123</a><br><span style=\"color: #789922;\">&gt;qq</span></article>" },
